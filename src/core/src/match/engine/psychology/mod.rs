...
mod tests {
    ...
    fn high_morale_lifts_initial_confidence() {
        let high = Psychology::initial_confidence(85.0, 14.0, true);
        let low = Psychology::initial_confidence(20.0, 14.0, true);
        assert!(high > low);
    ...
    fn pressure_attribute_reduces_initial_nervousness() {
        let cool = Psychology::initial_nervousness(18.0, 16.0, 0.9);
        let nervous = Psychology::initial_nervousness(6.0, 8.0, 0.9);
        assert!(cool < nervous);
    }

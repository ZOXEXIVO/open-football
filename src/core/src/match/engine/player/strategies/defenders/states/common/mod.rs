...
pub enum ActivityIntensity {
    /// Very high intensity - explosive actions (tackling, shooting, heading, sliding)
    VeryHigh,
    /// High intensity - sustained running, pressing, intercepting
    High,
    /// Moderate intensity - marking, tracking, returning, covering
    Moderate,
...
/// Defender condition processor
pub struct DefenderCondition {
    intensity: ActivityIntensity,
    use_velocity: bool,
}

impl DefenderCondition {
    ...
    pub fn process(self, mut ctx: ConditionContext) {

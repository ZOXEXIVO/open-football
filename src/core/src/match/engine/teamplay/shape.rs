...
//! decision: [`TeamTacticalState`](super::tactical) says how we are
...
const LENGTH_COMPACT: f32 = 220.0;
...
pub struct TeamShape {
    anchors: [(u32, Vector3<f32>); MAX_ON_PITCH],
    len: usize,
...
impl ShapeBuilder<'_> {
    ...
    fn build(&self, shape: &mut TeamShape) {

//! One transaction, start to finish: what a buyer puts on the table, how
//! the two clubs and the player argue about it, and what the completed
//! move leaves behind in the record.

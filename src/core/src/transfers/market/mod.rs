//! The market itself: what is for sale, where the money and the players
//! move between countries, and when a registration may be filed.
//!
//! Everything here is market STATE and market GEOGRAPHY. No pass runs from
//! this folder; the tick-time passes live in `pipeline`.
...
pub struct MarketStoryCounters {
    ...
    /// listed — see [`crate::transfers::AssetLedger`].

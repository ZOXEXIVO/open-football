...
//! [`ListedTargetScreen::evaluate`] gates (tier window, affordability, wage
...
//! ([`crate::transfers::scouting::breakout::LeaguePerformanceLookup::breakout_for_youth`]),
...
impl PipelineProcessor {
    ...
    pub(in crate::transfers) fn breakout_watch_per_pass(rep_score: f32) -> usize {
    ...
    /// adding.
    pub(in crate::transfers) fn breakout_watch_monitor_cap(rep_score: f32) -> usize {

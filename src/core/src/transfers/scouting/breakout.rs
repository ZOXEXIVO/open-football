...
pub(in crate::transfers) struct BreakoutInputs {
...
#[derive(Debug, Clone, Copy)]
pub(in crate::transfers) struct BreakoutPerformanceSignal {
...
impl BreakoutPerformanceSignal {
    ...
    /// sits below it.
    pub(in crate::transfers) const BREAKOUT_THRESHOLD: f32 = 45.0;

    pub(in crate::transfers) fn compute(inp: &BreakoutInputs) -> BreakoutPerformanceSignal {
    ...
    pub(in crate::transfers) fn compute_undiscounted(
        inp: &BreakoutInputs,
    ...
    pub(in crate::transfers) fn is_breakout(&self) -> bool {
...
/// queried per player.
pub(in crate::transfers) struct LeaguePerformanceLookup {
...
impl LeaguePerformanceLookup {
    ...
    pub(in crate::transfers) fn scoring_rank(&self, player_id: u32) -> Option<u8> {
        self.scoring_rank.get(&player_id).copied()
    }

    pub(in crate::transfers) fn is_top_scorer(&self, player_id: u32) -> bool {
        self.scoring_rank.get(&player_id) == Some(&1)
    }

    pub(in crate::transfers) fn award_points(&self, player_id: u32) -> f32 {
    ...
    pub(in crate::transfers) fn breakout_inputs(
        &self,
        player_id: u32,
    ...
    pub(in crate::transfers) fn breakout_for_player(
        &self,
        player: &Player,
        appearances: u16,
        average_rating: f32,
    ...
    pub(in crate::transfers) fn breakout_for_youth(
        &self,
        player: &Player,
        appearances: u16,
        average_rating: f32,

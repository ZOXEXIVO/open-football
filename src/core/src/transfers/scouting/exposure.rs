...
use crate::transfers::gate::TransferPlausibilityReason;
use crate::transfers::pipeline::advice::ListedRejectReason;
...
pub(in crate::transfers) enum ExposureStage {
...
impl ExposureStage {
    pub(in crate::transfers) fn from_days(days: i64) -> Self {
        match days {
...
pub(in crate::transfers) struct AvailabilitySignals {
...
#[derive(Debug, Clone, Copy)]
pub(in crate::transfers) struct AvailabilityExposure {
...
impl AvailabilityExposure {
    ...
    pub(in crate::transfers) fn compute(s: &AvailabilitySignals) -> AvailabilityExposure {
...
impl MarketDiscoveryDiagnosis {
    ...
    pub(in crate::transfers) fn from_plausibility(
    ...
    pub(in crate::transfers) fn dominant(
...
#[derive(Debug, Clone, Copy)]
pub(in crate::transfers) struct FreeAgentRecommendationSignals {
    pub current_ability: u8,
    pub estimated_potential: u8,
    pub age: u8,
...
#[derive(Debug, Clone, Copy)]
pub(in crate::transfers) struct FreeAgentBuyerContext {
...
pub(in crate::transfers) struct OpportunisticFreeAgentScout;

impl OpportunisticFreeAgentScout {
    pub(in crate::transfers) fn should_recommend(

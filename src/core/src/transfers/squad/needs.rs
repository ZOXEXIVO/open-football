...
/// bodies. Matches the way `GroupNeedScan::depth_requirement`
/// pads back-fours.
...
pub struct EmergencyBuyerContext {
    ...
    /// the buyer's [`crate::transfers::market::region::ScoutingRegion`].
...
impl EmergencyBuyerContext {
    ...
    /// [`crate::transfers::gate::fit::ForeignSlotCount::would_block`]

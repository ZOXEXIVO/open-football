...
pub use news::{
    ...
    ClubTransferWeek, IssueResult, MarketDesk, MatchDesk, NewsDesk, NewsEditor, NewsRecurrence,
    NewsStory, NewsStoryKind, NewspaperIssue, PressMood, SquadDesk, StandingSnapshot, TableDesk,
    TeamNewsroom, WeeklyMatchFacts,
};

...
/// What a graduating academy player is put on.
pub(in crate::club::core) struct GraduationTerms;

impl GraduationTerms {
    /// Ability sets the tier, club reputation scales it. A youth graduate at
    /// Man City earns 50x what the same ability player earns in Chad.
    pub(in crate::club::core) fn salary(current_ability: u8, club_reputation: u16) -> u32 {

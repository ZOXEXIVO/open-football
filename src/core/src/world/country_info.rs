...
pub struct CountryInfo {
    ...
    /// league in a given save and the half of the card that matters for them
    /// — where their nationals go, and where their diaspora lives — is
    /// exactly the half a leagueless country still has.

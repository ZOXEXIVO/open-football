...
pub struct PerfView {
    ...
    pub ai_batch_ms: String,
    pub ai_batch_pct: u32,
    pub ai_batch_active: bool,
    pub ai_batch_pill: &'static str,
...
impl PerfView {
    fn from_snapshot(snap: core::PerfSnapshot, pool_workers: usize) -> Self {
        ...
        PerfView {
            ...
            ai_batch_ms: fmt_ms(snap.ai_batch_ns),
            ai_batch_pct: pct_of(snap.ai_batch_ns, total),
            ai_batch_active: snap.ai_active,
            ai_batch_pill: pill_for(snap.ai_batch_ns as f64 / 1_000_000.0, 50.0, 200.0),

...
fn apply_country_bias(b: &mut [f32; SKILL_COUNT], code: &str) -> bool {
    match code {
        ...
        "br" => {
            ...
            b[SK_DRIBBLING] = 2.0;
            b[SK_TECHNIQUE] = 1.5;
            b[SK_FIRST_TOUCH] = 1.0;
            b[SK_FINISHING] = 0.5;
            b[SK_FREE_KICKS] = 0.5;
            b[SK_FLAIR] = 2.0;
            b[SK_OFF_THE_BALL] = 0.5;
            b[SK_COMPOSURE] = 0.5;
            b[SK_AGILITY] = 0.5;
            b[SK_BALANCE] = 0.5;
            b[SK_ACCELERATION] = 0.5;
            // Tradeoffs
        ...
        "it" => {
            ...
            b[SK_POSITIONING] = 1.5;
            b[SK_CONCENTRATION] = 1.0;
            b[SK_COMPOSURE] = 1.0;
            b[SK_ANTICIPATION] = 0.5;
            b[SK_DECISIONS] = 0.5;
            b[SK_MARKING] = 0.5;
            b[SK_TACKLING] = 0.5;
            b[SK_TECHNIQUE] = 0.5;
        ...
        "ng" => {
            ...
            b[SK_PACE] = 2.0;
            b[SK_ACCELERATION] = 1.5;
            b[SK_STRENGTH] = 1.5;
            b[SK_NATURAL_FITNESS] = 1.0;
            b[SK_JUMPING] = 0.5;
            b[SK_DRIBBLING] = 0.5;
            // Tradeoffs
            b[SK_POSITIONING] = -0.5;
